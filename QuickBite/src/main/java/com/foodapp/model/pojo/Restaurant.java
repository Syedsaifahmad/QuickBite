...
public class Restaurant {
	...
	public Restaurant(String restaurantName, String cuisineType, String address, int rating, boolean isActive, String image) {
		super();
	...
	public String toString() {
		return "Restaurant [restaurantId=" + restaurantId + ", restaurantName=" + restaurantName + ", cuisineType="
				+ cuisineType + ", address=" + address + ", rating=" + rating + ", isActive=" + isActive +", image=" + image + "]";
	}
